...
const CANONICAL_ORIGIN = "https://harrisinwonderland.com";
const PRODUCTION_ORIGINS: string[] = [
  CANONICAL_ORIGIN,
  "https://www.harrisinwonderland.com",
  "https://harris-wonderland.vercel.app",
  "https://harris-wonderland-nickhsousa96-8307s-projects.vercel.app",
  "https://harris-wonderland-git-main-nickhsousa96-8307s-projects.vercel.app",
];

const explicitBaseURL = isProduction ? CANONICAL_ORIGIN : env("BETTER_AUTH_URL");
