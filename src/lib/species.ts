...
export const ANIMAL_TAXONOMY: AnimalCategory[] = [
  ...
  { id: "lizards", slug: "lizards", name: "Lizards", parentId: "reptiles", description: "Geckos, chameleons, and other lizards.", inventoryKeywords: ["lizard", "gecko", "chameleon"] },
...
export const SPECIES: Species[] = [
  ...
  },
  {
    ...
    alt: "Red-Footed Tortoise portrait",
    ...
    humidity: "70–80% for the shell. Dry conditions can cause pyramiding.",
    diet: "Greens, fruit in measure, animal protein in small doses. Every day.",
    note: "Red-Footed Tortoises or Russian tortoises are beginner species the shop can discuss.",
  },
  {
    id: "horned-frog",
    ...
    note: "Pacmans rotate. Ask which mouth is actually eating.",
  },
  {
    id: "red-eyed",
  ...
  },
  {
    ...
    alt: "Dyeing poison dart frog at Harris in Wonderland",
...
export const CHOOSER = [
  ...
  },
  {
    ...
    role: "Lizards",
    title: "Leopard gecko",
    body: "Leopard geckos. Most lizards would rather be watched than handled. Budget the UV and the heat before the animal.",
    speciesId: "leopard-gecko",
  },
  {
    id: "shell",
    role: "Turtles & Tortoises",
    title: "Red-Footed Tortoises",
